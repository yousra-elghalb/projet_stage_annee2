...
@Component({
  ...
  templateUrl: './list-voyageur-pgroupe-national.component.html',
  styleUrls: ['./list-voyageur-pgroupe-national.component.scss']
})
export class ListVoyageurPgroupeNationalComponent implements OnInit {
