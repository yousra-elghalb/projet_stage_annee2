...
@Component({
  ...
  templateUrl: './list-voyageur-sgroupe-international.component.html',
  styleUrls: ['./list-voyageur-sgroupe-international.component.scss']
})
export class ListVoyageurSgroupeInternationalComponent implements OnInit {
