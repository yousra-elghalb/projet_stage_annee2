...
@Component({
  selector: 'app-dialog-offre-voyage-limited',
  templateUrl: './dialog-add-offre-voyage-limited.component.html',
  styleUrls: ['./dialog-add-offre-voyage-limited.component.scss']
})
export class DialogAddOffreVoyageLimitedComponent implements OnInit, OnDestroy {
  ...
  constructor(public dialogRef: MatDialogRef<DialogAddOffreVoyageLimitedComponent>,
