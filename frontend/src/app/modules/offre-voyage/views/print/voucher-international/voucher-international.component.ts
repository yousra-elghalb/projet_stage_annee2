...
@Component({
  selector: 'app-voucher-international',
  templateUrl: './voucher-international.component.html',
  styleUrls: ['./voucher-international.component.scss'],
})
export class VoucherInternationalComponent implements OnInit {
